...
public void AdminLogin() throws InterruptedException {
    ...
    Thread.sleep(2000);
    AddCategoryPOM.CatName("ORNAMENTS");
    AddCategoryPOM.CatDesc("ornaments for ladies");
    AddCategoryPOM.metatitle("ORNAMENTS");
    AddCategoryPOM.metadesc("ornaments for ladies");
    AddCategoryPOM.submit();
    Assert.assertTrue(true,"Success:You have modified categories!");
